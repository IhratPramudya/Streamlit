...
st.latex("D_e 1 = \sqrt{(150 - 110)^2 + (7.5 - 8)^2} = 30.0025")
st.latex("D_e 2 = \sqrt{(130 - 110)^2 + (6.8 - 8)^2} = 10.0717")
st.latex("D_e 3 = \sqrt{(11020 - 110)^2 + (8 - 8)^2} = 0")
st.latex("D_e 4 = \sqrt{(5 - 110)^2 + (1,2 - 8)^2} = 7.711")
st.latex("D_e 5 = \sqrt{(1,500 - 110)^2 + (15 - 8)^2} = 7.9398")
st.latex("D_e 6 = \sqrt{(160 - 110)^2 + (7,8 - 8)^2} = 40.000")
st.latex("D_e 7 = \sqrt{(140 - 110)^2 + (7 - 8)^2} = 20.0449")
st.latex("D_e 8 = \sqrt{(110 - 110)^2 + (7,9 - 8)^2} = 10.0004")
st.latex("D_e 9 = \sqrt{(6 - 110)^2 + (1,3 - 8)^2} = 7.6082")
st.latex("D_e 10 = \sqrt{(1,450 - 110)^2 + (14,8 - 8)^2} = 7.7649")
st.write("Iterasi 1 kluster 2")
st.latex("D_e 1 = \sqrt{(150 - 110)^2 + (7.5 - 7.9)^2} = 30.0025")
st.latex("D_e 2 = \sqrt{(130 - 110)^2 + (6.8 - 7.9)^2} = 10.0717")
st.latex("D_e 3 = \sqrt{(120 - 110)^2 + (8 - 7.9)^2} = 0")
st.latex("D_e 4 = \sqrt{(5 - 110)^2 + (1,2 - 7.9)^2} = 7.711")
st.latex("D_e 5 = \sqrt{(1,500 - 110)^2 + (15 - 7.9)^2} = 7.9398")
st.latex("D_e 6 = \sqrt{(160 - 110)^2 + (7,8 - 7.9)^2} = 40.000")
st.latex("D_e 7 = \sqrt{(140 - 110)^2 + (7 - 7.9)^2} = 20.0449")
st.latex("D_e 8 = \sqrt{(110 - 110)^2 + (7,9 - 7.9)^2} = 10.0004")
st.latex("D_e 9 = \sqrt{(6 - 110)^2 + (1,3 - 7.9)^2} = 7.6082")
st.latex("D_e 10 = \sqrt{(1,450 - 110)^2 + (14,8 - 7.9)^2} = 7.7649")
